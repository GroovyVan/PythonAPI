...
class TestUserAuth:
    def test_auth_user(self):
        ...
        assert "user_id" in response1.json(), "There is no uset ID in the response"
        ...
        assert user_id_from_auth_method == user_id_from_check_method, "User id from auth method is not equal to user is from check method"
